                ...
                return function __do() {
                    ...
                    if (v1.isDrawing) {
                        ...
                        Data_Functor["void"](Effect.functorEffect)(Effect_Ref.modify(function (b) {
                            var $45 = {};
                            for (var $46 in b) {
                                if ({}.hasOwnProperty.call(b, $46)) {
                                    $45[$46] = b[$46];
                                };
                            };
                            $45.hue = incHue(b.hue);
                            $45.lastX = $foreign.offsetX(e);
                            $45.lastY = $foreign.offsetY(e);
                            return $45;
                        })(v.drawingStateRef))();
                        Data_Functor["void"](Effect.functorEffect)((function () {
                            var $48 = v1.lineWidth >= 100.0;
                            if ($48) {
                                return Effect_Ref.modify_(function (b) {
                                    var $49 = {};
                                    for (var $50 in b) {
                                        if ({}.hasOwnProperty.call(b, $50)) {
                                            $49[$50] = b[$50];
                                        };
                                    };
                                    $49.direction = true;
                        ...
                        Data_Functor["void"](Effect.functorEffect)((function () {
                            var $52 = v1.lineWidth <= 1.0;
                            if ($52) {
                                return Effect_Ref.modify_(function (b) {
                                    var $53 = {};
                                    for (var $54 in b) {
                                        if ({}.hasOwnProperty.call(b, $54)) {
                                            $53[$54] = b[$54];
                                        };
                                    };
                                    $53.direction = false;
                        ...
                        return Data_Functor["void"](Effect.functorEffect)((function () {
                            if (v1.direction) {
                                return Effect_Ref.modify_(function (b) {
                                    var $57 = {};
                                    for (var $58 in b) {
                                        if ({}.hasOwnProperty.call(b, $58)) {
                                            $57[$58] = b[$58];
                                        };
                                    };
                                    $57.lineWidth = b.lineWidth - 1.0;
                                    return $57;
                                })(v.drawingStateRef);
                            };
                            return Effect_Ref.modify_(function (b) {
                                var $60 = {};
                                for (var $61 in b) {
                                    if ({}.hasOwnProperty.call(b, $61)) {
                                        $60[$61] = b[$61];
                                    };
                                };
                                $60.lineWidth = b.lineWidth + 1.0;
                                return $60;
                            })(v.drawingStateRef);
                        })())();
                    };
                    ...
                    throw new Error("Failed pattern match at FunWithHTML5Canvas (line 72, column 5 - line 94, column 25): " + [ v1.isDrawing.constructor.name ]);
                };
            }));
        });
    };
...
var drawingMouseUp$prime = function (drawingState) {
    return function (e) {
        return Effect_Ref.modify_(function (b) {
            return {
                isDrawing: false,
...
var drawingMouseDown$prime = function (drawingState) {
    return function (e) {
        return Effect_Ref.modify_(function (b) {
            return {
                isDrawing: true,
...
var draw$prime = function (drawingStateRef) {
    return function (context2d) {
        return function (e) {
            ...
            return function __do() {
                var v = Effect_Ref.read(drawingStateRef)();
                if (v.isDrawing) {
                    Graphics_Canvas.setStrokeStyle(context2d)("hsl(" + (Data_Show.show(Data_Show.showNumber)(v.hue) + ", 100%, 50%)"))();
                    Graphics_Canvas.setLineWidth(context2d)(v.lineWidth)();
                    Graphics_Canvas.beginPath(context2d)();
                    Graphics_Canvas.moveTo(context2d)(v.lastX)(v.lastY)();
                    Graphics_Canvas.lineTo(context2d)($foreign.offsetX(e))($foreign.offsetY(e))();
                    Graphics_Canvas.stroke(context2d)();
                    Data_Functor["void"](Effect.functorEffect)(Effect_Ref.modify(function (b) {
                        return {
                            hue: incHue(b.hue),
                            lastX: $foreign.offsetX(e),
                            lastY: $foreign.offsetY(e),
                            direction: b.direction,
                            isDrawing: b.isDrawing,
                            lineWidth: b.lineWidth
                        };
                    })(drawingStateRef))();
                    Data_Functor["void"](Effect.functorEffect)((function () {
                        var $69 = v.lineWidth >= 100.0;
                        if ($69) {
                            return Effect_Ref.modify_(function (b) {
                                return {
                                    direction: true,
                ...
                throw new Error("Failed pattern match at FunWithHTML5Canvas (line 101, column 3 - line 123, column 23): " + [ v.isDrawing.constructor.name ]);
            };
        };
    };
};
var main = function __do() {
    ...
    if (v1 instanceof Data_Maybe.Just) {
        ...
        listener(elementToEventTarget)(drawingMouseDown$prime(v2))(Web_UIEvent_MouseEvent_EventTypes.mousedown)(v1.value0)();
        listener(elementToEventTarget)(drawingMouseUp$prime(v2))(Web_UIEvent_MouseEvent_EventTypes.mouseup)(v1.value0)();
        return listener(elementToEventTarget)(draw$prime(v2)(v5))(Web_UIEvent_MouseEvent_EventTypes.mousemove)(v1.value0)();
    };
    throw new Error("Failed pattern match at FunWithHTML5Canvas (line 176, column 3 - line 195, column 74): " + [ v1.constructor.name ]);
};
module.exports = {
    ...
    "drawingMouseDown'": drawingMouseDown$prime,
    "drawingMouseUp'": drawingMouseUp$prime,
    main: main,
